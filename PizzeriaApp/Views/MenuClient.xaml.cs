...
public partial class MenuClient : FlyoutPage
{
    ...
    public MenuClient(string usuarioId) //Constructor de la clase MenuClient, recibe el id del usuario como parametro para mostrar su perfil en la pantalla del cliente
    {
		InitializeComponent();
