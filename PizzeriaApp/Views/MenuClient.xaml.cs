...
namespace PizzeriaApp.Views
{
    ...
    public partial class MenuClient : ContentPage
    {
        ...
        public MenuClient(UsuarioPerfil cliente)
        {
            ...
            // Inicializamos el controlador de pedidos
        ...
        protected override async void OnAppearing()
        {
            ...
            // Pedimos el menú al controlador en lugar de a la base de datos directo
        ...
        {
            // El controlador orquesta la obtención de productos activos
            _catalogoCompleto = await _controller.ObtenerMenuAsync();
